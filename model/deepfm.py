...
class DeepFM(BaseModel):
    def __init__(self, linear_feature_columns, dnn_feature_columns,  total_feature_num, use_fm=True, dnn_hidden_units=(300,300,128),
        ...
        super(DeepFM, self).__init__(linear_feature_columns, dnn_feature_columns, total_feature_num, l2_reg_linear=l2_reg_linear,
    ...
    def forward(self, inputs):
        # print(inputs.shape) # B 7 for movielens
        ...
        if self.use_dnn:
            ...
            logit += dnn_logit
        # print(logit.shape, fm_input.shape, dnn_input.shape, dnn_output.shape)
