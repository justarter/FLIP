...
class Linear(nn.Module):
    def __init__(self, feature_columns, feature_index, total_feature_num, init_std=0.0001, device='cpu'):
        ...
        self.embedding_dict = create_embedding_matrix(feature_columns, total_feature_num, init_std, linear=True, sparse=False,
                                                      device=device)
...
class BaseModel(nn.Module):
    def __init__(self, linear_feature_columns, dnn_feature_columns, total_feature_num, l2_reg_linear=1e-5, l2_reg_embedding=1e-5,
        ...
        self.embedding_dict = create_embedding_matrix(dnn_feature_columns, total_feature_num, init_std, sparse=False, device=device)
